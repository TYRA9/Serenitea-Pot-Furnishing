            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        <!-- Single Wedge Start -->
                        <%-- 如果管理员处于正常登录状态，就可以正常使用后台管理页面的相关功能。 --%>
                        ...
                        <%-- 如果管理员没有正常登录，就跳转到管理员登录页面 --%>
                        <c:if test="${empty requestScope.mgrId}">
                            <div class="header-bottom-set dropdown">
                                <a href="views/manager/manage_login.jsp">Please log in first!</a>
                            </div>
                            <div class="header-bottom-set dropdown">
                                <a href="views/manager/manage_login.jsp">Furnishing Admin</a>
                            </div>
                            <div class="header-bottom-set dropdown">
                                <a href="views/manager/manage_login.jsp">Order Admin</a>
                            </div>
                        </c:if>
                    </div>
                </div>
...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title" style="font-family: consolas">Furnishings Admin Menu</h3>
        <div class="row">
